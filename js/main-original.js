...
function onAddText() {
    ...
    // console.log("document.getElementById('my-canvas'):", document.getElementById('my-canvas'))
...
function drawText(lines) {
    ...
    lines.forEach(line => {
        var xPos = line.x;
        var yPos = line.y;
        // console.log("xPos, yPos, line.txt, line.size, line.align:", xPos, yPos, line.txt, line.size, line.align)
        // drawRect(xPos, yPos, line.txt, line.size, line.align);
        // console.log("textWidth:", line.txt)
